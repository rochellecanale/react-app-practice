                    ...
                    <div className="flex items-center">
                        ...
                        <div className="hidden md:block">
                            <div className="ml-10 flex items-baseline space-x-4">
                                ...
                                <Link 
                                    to="/" 
                                    className={`${ location.pathname == '/' ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" } px-3 py-2 rounded-md text-sm font-medium`}>Home
                                </Link>
                                <Link 
                                    to="mini-projects" 
                                    className={`${ location.pathname == '/mini-projects' ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" } px-3 py-2 rounded-md text-sm font-medium`}>Projects
                                </Link>
                                <Link 
                                    to="profile" 
                                    className={`${ location.pathname == '/profile' ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" } px-3 py-2 rounded-md text-sm font-medium`}>Profile
                                </Link>
